...
import { UserContextProvider } from "../pages/user-managment/UserContext";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/ecommerce/index`}
          component={EcomDashboard}
        ></Route>
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/ecommerce/orders`}
          component={EcomOrder}
        ></Route>
        <Route
          exact
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/ecommerce/support`}
          component={EcomSupport}
        ></Route>
        <Route
          exact
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/ecommerce/integration`}
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/order-list-default`}
          component={OrderDefault}
        ></Route>
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/order-list-regular`}
          component={OrderRegular}
        ></Route>
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/order-list-sales`}
